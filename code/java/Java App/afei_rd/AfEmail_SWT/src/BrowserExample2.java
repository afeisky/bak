    ...
    public class BrowserExample2 {  
        ...
        public BrowserExample2(Composite parent) {  
        ...
        public static void main(String[] args) {  
            ...
            BrowserExample2 instance = new BrowserExample2(shell);
            
            Image icon = new Image(display, "./go.gif");  //new Image(display, "C:/icons/web/go.gif");  
            shell.setImage(icon);  
            shell.open();  
