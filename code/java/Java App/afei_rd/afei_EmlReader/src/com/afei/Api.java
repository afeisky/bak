...
public class Api {
	...
	public static String decodeText(String str){
		try{ 
			log(MimeUtility.getDefaultJavaCharset());
...
//			}
	...
	public static void initImageResourse(Shell _shell) {
		shell = _shell;
		iconFolder = null;// new Image(shell.getDisplay(),
							// "C:/icons/web/go.gif");
		iconFile = null;// new Image(shell.getDisplay(), "C:/icons/web/go.gif");
	}
